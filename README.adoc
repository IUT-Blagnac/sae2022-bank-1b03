...
|         | CdC V1      |                                   |   
|         | Suivi Projet |                                   |J'ai 3 contributeurs alors que vous êtes 4 ... attention aux pseudos, je peux identifier que Sean et Hugo.   De même je n'ai que Sean sur les tâches terminées V1 ... qu'on fait les autres ?. Penser à organiser l'arboresence de votre repository par livraison.          
