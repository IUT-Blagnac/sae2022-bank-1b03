...
Cliquez sur "Enregistrer Crédit" pour commencer l'enregistrement un nouveau crédit.
...
Par la suite vous pouvez voir le solde du compte en haut de l'écrant.
Vous devez rentrer un montant supérieur à 0 et inférieur au solde du compte.
Puis selectionner le compte destinataire du virment et clicker sur "Envoyer".
