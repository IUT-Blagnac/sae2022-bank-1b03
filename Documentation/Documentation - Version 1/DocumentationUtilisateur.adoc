...
Vous pouvez cliquez sur le bouton "Nouveau compte" afin de créer un nouveau compte en entrant le solde du compte initial (_*supérieur à 50 !*_) et le découvert autorisé.

Quand vous avez fini, appuyez sur le bouton "Ajouter". Un nouveau compte a été créé !
